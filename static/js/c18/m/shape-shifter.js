...
$(document).ready(function() {
    ...
    S.ShapeBuilder = ( function() {
            var gap = 3, shapeCanvas = document.createElement('canvas'), shapeContext = shapeCanvas.getContext('2d'), fontSize = 500, fontFamily = '微软雅黑, Avenir, Helvetica Neue, Helvetica, Arial, sans-serif';
